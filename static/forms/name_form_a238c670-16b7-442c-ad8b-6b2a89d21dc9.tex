...
\begin{itemize}[leftmargin=0.7cm]
	...
	\item \CheckedBox{no} Update/Add Social Security Number (Complete Section B)
\end{itemize}
...
FROM: & & TO: & \\
First name & \makebox[4cm][l]{\textbf{jamascar@CougarNet.UH.EDU}} \underline{\hspace{4cm}} & First name & \makebox[4cm][l]{\textbf{e}} \underline{\hspace{4cm}} \\
Middle name & \makebox[4cm][l]{\textbf{e}} \underline{\hspace{4cm}} & Middle name & \makebox[4cm][l]{\textbf{e}} \underline{\hspace{4cm}} \\
Last name & \makebox[4cm][l]{\textbf{Nonee}} \underline{\hspace{4cm}} & Last name & \makebox[4cm][l]{\textbf{e}} \underline{\hspace{4cm}} \\
Suffix & \makebox[4cm][l]{\textbf{e}} \underline{\hspace{4cm}} & Suffix & \makebox[4cm][l]{\textbf{e}} \underline{\hspace{4cm}} \\
\end{tabular}
...
\begin{itemize}[leftmargin=0.7cm]
	...
	\item \CheckedBox{yes} Correction of Error
\end{itemize}
...
\vspace{1em}
\noindent\textbf{*SIGNATURE (REQUIRED)} \includegraphics[width=5cm]{C:\Users\johnp\Desktop\Edmonton-v.02\static\uploads\signatures\7ee0cdba-c997-4c93-975a-f44f97582852.jpg} Date 2025-04-24
