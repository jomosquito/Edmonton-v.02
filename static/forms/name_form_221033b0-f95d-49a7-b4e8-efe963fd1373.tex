...
FROM: & & TO: & \\
First name & \makebox[4cm][l]{\textbf{jamascar@CougarNet.UH.EDU}} \underline{\hspace{4cm}} & First name & \makebox[4cm][l]{\textbf{}} \underline{\hspace{4cm}} \\
...
\vspace{1em}
\noindent\textbf{*SIGNATURE (REQUIRED)} \includegraphics[width=5cm]{static/uploads/signatures/70d50f3d-f228-4922-a152-5431b1a5d776.jpg} Date 2025-04-24
