...
\begin{tabular}{ll}
Name: & \textbf{jpgleite@CougarNet.UH.EDU w None} \\
myUH ID: & \textbf{w} \\
College: & \textbf{w} \\
Plan/Degree: & \textbf{w} \\
\end{tabular}
...
\begin{tabular}{ll}
Address: & \textbf{None} \\
City, State, Zip: & \textbf{w}, \textbf{w} \textbf{w} \\
Phone: & \textbf{None} \\
...
\begin{tabular}{ll}
Signature: & \includegraphics[width=5cm]{c:/Users/johnp/Desktop/Edmonton-v.02/static/temp/static/uploads/signatures/sig_1_20250424052049.png} \\
