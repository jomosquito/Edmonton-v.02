...
\begin{tabular}{ll}
Name: & \textbf{ngupta21@CougarNet.UH.EDU  Gupta} \\
myUH ID: & \textbf{213123} \\
College: & \textbf{University of Houston} \\
Plan/Degree: & \textbf{sdasda} \\
\end{tabular}
...
\begin{tabular}{ll}
Address: & \textbf{asdadsasd} \\
City, State, Zip: & \textbf{asda}, \textbf{texas} \textbf{231313} \\
Phone: & \textbf{1231123213} \\
...
\begin{tabular}{ll}
Term \& Year for Withdrawal: & \textbf{Fall 2025} \\
\end{tabular}
...
\begin{tabular}{ll}
Last Date: & \textbf{November 23, 2021} \\
\end{tabular}
...
\begin{tabular}{ll}
Signature: & \includegraphics[width=5cm]{/Users/zorro/Documents/GitHub/Edmonton-v.02/static/uploads/signatures/sig_3_20250423193444_image.png} \\
Date: & \textbf{April 23, 2025} \\
\end{tabular}
...
\begin{tabular}{ll}
Date Submitted: & \textbf{April 23, 2025} \\
