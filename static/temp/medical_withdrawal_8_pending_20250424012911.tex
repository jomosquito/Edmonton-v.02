...
\begin{tabular}{ll}
Name: & \textbf{jamascar@CougarNet.UH.EDU  Gupta} \\
myUH ID: & \textbf{2199291} \\
College: & \textbf{uh} \\
...
\begin{tabular}{ll}
Address: & \textbf{big address} \\
City, State, Zip: & \textbf{ghs}, \textbf{asda} \textbf{asddasd} \\
Phone: & \textbf{1233451312} \\
Email: & \textbf{jamascar@CougarNet.UH.EDU} \\
\end{tabular}
...
\begin{tabular}{ll}
Term \& Year for Withdrawal: & \textbf{Summer 2025} \\
\end{tabular}
...
\begin{tabular}{ll}
Last Date: & \textbf{September 29, 8228} \\
\end{tabular}
