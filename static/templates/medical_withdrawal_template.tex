...
\begin{tabular}{ll}
Term \& Year for Withdrawal: & \textbf{##TERM_YEAR##} \\
\end{tabular}
...
\begin{tabular}{ll}
Financial Assistance: & \textbf{##FINANCIAL_ASSISTANCE##} \\
UH Student Health Insurance: & \textbf{##HEALTH_INSURANCE##} \\
Campus Housing: & \textbf{##CAMPUS_HOUSING##} \\
F1/J1 Visa: & \textbf{##VISA_STATUS##} \\
G.I. Bill Benefits: & \textbf{##GI_BILL##} \\
\end{tabular}
...
\begin{tabular}{ll}
Number of Documents Submitted: & \textbf{##DOCUMENTATION_COUNT##} \\
Files: & \textbf{##DOCUMENTATION_FILES##} \\
\end{tabular}
...
\begin{tabular}{ll}
Date Submitted: & \textbf{##CREATED_DATE##} \\
